import { html, render, useState, useEffect } from '../../libraries/preact/standalone-module.js';

const Inspector = ({border}) => {
  ...
  return html`
    <div class="text-[.6rem] text-left">
      ...
      <!-- themes -->
      <div class="border-0 border-b border-solid pb-2 mb-4 ${border}">
